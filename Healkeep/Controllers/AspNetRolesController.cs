...
namespace Healkeep.Controllers
{
    public class AspNetRolesController : Controller
    {
        ...
        public ActionResult Create(FormCollection formCollection)
        {
            ...
            //aspNetRole.Id = "1";
            aspNetRole.Name = formCollection["Name"];

            AspNetRoleBusinessLayer aspNetRoleBusinessLayer = new AspNetRoleBusinessLayer();
            aspNetRoleBusinessLayer.AddAspNetRole(aspNetRole);
